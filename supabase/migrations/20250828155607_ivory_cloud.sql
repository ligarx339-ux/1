-- Create database
CREATE DATABASE IF NOT EXISTS uc_coin_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS users (
    ...
    INDEX idx_mining_status (is_mining, mining_start_time)
...
INSERT IGNORE INTO config (setting_key, setting_value) VALUES 
    ...
    ('bot_username', 'UCCoinUltraBot'),
    ('banner_url', 'https://mining-master.onrender.com//assets/banner-BH8QO14f.png');

-- Insert sample missions
INSERT IGNORE INTO missions (id, title, description, reward, channel_id, active, category, type, priority) VALUES
    ('-OSz3HnagzpKsjgscU3z', 'Join Telegram Channel', 'Join our Telegram channel to get exclusive updates and bonuses!', 999999, 'ligarx_boy', TRUE, 'Join', 'join_channel', 1),
    ('-OVC9E-9cHsjQGpmAo6S', 'Website Visit Timer', 'Visit the website and stay for 14 seconds to earn DRX coins!', 10, NULL, TRUE, 'Timer', 'url_timer', 2),
    ('-OVC9vcdrupIhHosbDLJ', 'Secret Promo Code', 'Visit the URL and find the secret promo code to earn rewards!', 100, NULL, TRUE, 'Code', 'promo_code', 3);

-- Update missions with URLs and codes
UPDATE missions SET url = 'https://login.emaktab.uz/captcha/true/ef7f6614-65ad-43d1-93fd-840034956ca0', required_time = 14 WHERE id = '-OVC9E-9cHsjQGpmAo6S';
UPDATE missions SET url = 'https://dzen.ru/video/watch/636f539607acf23553b285b8?share_to=link', code = 'salom23' WHERE id = '-OVC9vcdrupIhHosbDLJ';